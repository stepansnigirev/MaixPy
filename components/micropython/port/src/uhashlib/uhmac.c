...
STATIC mp_obj_t hmac_HMAC_make_new_helper(const mp_obj_type_t *type, size_t n_args, const mp_obj_t *pos_args, mp_map_t *kwargs){
    ...
    static const mp_arg_t allowed_args[] = {
        { MP_QSTR_key, MP_ARG_OBJ, {.u_rom_obj = MP_OBJ_NULL} },
        { MP_QSTR_msg, MP_ARG_OBJ, {.u_rom_obj = MP_OBJ_NULL} },
        { MP_QSTR_digestmod, MP_ARG_OBJ, {.u_rom_obj = MP_OBJ_NULL} },
    };
    ...
    if (args[ARG_message].u_obj != MP_OBJ_NULL) {
